...
(function () {
  ...
  const t = {
    ...
    // ═══════ HERO (index.html) ═══════
    'hero.eyebrow':  { uz: "Toshkentdagi tour operator · STIR 309775904", ru: "Туроператор из Ташкента · ИНН 309775904", en: "Tour operator from Tashkent · INN 309775904" },
    ...
    'hero.desc':     { uz: "Samarqand, Buxoro, Xiva — bu shaharlarda har bir tosh ming yillik tarixni saqlaydi. Biz mehmonlarni mamlakatimiz bilan tanishtiramiz va o'zbekistonliklar uchun jahon bo'ylab sayohatlarni tashkil qilamiz.",
                       ru: "Самарканд, Бухара, Хива — города, где каждый камень хранит тысячелетнюю историю. Помогаем гостям открыть нашу страну и организуем поездки за рубеж для жителей Узбекистана.",
                       en: "Samarkand, Bukhara, Khiva — cities where every stone holds a thousand years of history. We help guests discover our country and organise trips abroad for residents of Uzbekistan." },
    ...
    'hero.badge.num':{ uz: "100%",                ru: "100%",           en: "100%" },
    'hero.badge.lbl':{ uz: "individual yondashuv", ru: "индивидуально",  en: "individual approach" },
    ...
    'about.body':    { uz: "FENIX MULTIGLOBAL — Toshkentdagi kichik tour operator. Mamlakatni hurmat bilan ko'rsatamiz, har bir mehmonni shaxsan bilamiz va sinalgan gidlar hamda transport bilan ishlaymiz.",
                       ru: "FENIX MULTIGLOBAL — небольшая туристическая компания с офисом в Ташкенте. Показываем страну с уважением, знаем каждого гостя лично и работаем с проверенными гидами и транспортом.",
                       en: "FENIX MULTIGLOBAL is a small tour operator based in Tashkent. We show the country with respect, know every guest personally and work with trusted guides and transport." },
    'about.li.1':    { uz: "O'zbekiston Respublikasida rasmiy ro'yxatdan o'tgan",
                       ru: "Официально зарегистрированы в Республике Узбекистан",
                       en: "Officially registered in the Republic of Uzbekistan" },
    'about.li.2':    { uz: "Sinalgan gidlar va transport",
                       ru: "Проверенные гиды и транспорт",
                       en: "Trusted guides and transport" },
    'about.li.3':    { uz: "To'rt yo'nalish: ichki, kiruvchi, chiquvchi, MICE",
                       ru: "Четыре направления: внутренний, въездной, выездной, MICE",
                       en: "Four directions: domestic, inbound, outbound, MICE" },
    'about.li.4':    { uz: "Toshkent markazidagi ofis · STIR 309775904",
                       ru: "Офис в центре Ташкента · ИНН 309775904",
                       en: "Office in central Tashkent · INN 309775904" },

    'about.stat.1.num': { uz: "100%", ru: "100%", en: "100%" },
    'about.stat.1.lbl': { uz: "individual yondashuv", ru: "индивидуальный подход", en: "individual approach" },
    'about.stat.2.num': { uz: "4", ru: "4", en: "4" },
    'about.stat.2.lbl': { uz: "turizm yo'nalishi", ru: "направления туризма", en: "tourism directions" },
    'about.stat.3.num': { uz: "24/7", ru: "24/7", en: "24/7" },
    'about.stat.3.lbl': { uz: "qo'llab-quvvatlash", ru: "поддержка", en: "support" },
    ...
    'about.page.desc':    { uz: "Biz bir narsani qilamiz — odamlarga O'zbekistonni ko'rsatamiz va o'zbekistonliklarni dunyoga olib chiqamiz. Biz uchun bu konveyer emas, balki kasb.",
                            ru: "Мы делаем одно — показываем Узбекистан людям и отправляем узбекистанцев в мир. Для нас это не конвейер, а ремесло.",
                            en: "We do one thing — show Uzbekistan to people and send Uzbekistan residents into the world. For us it's a craft, not a conveyor belt." },
    ...
    'about.who.p1':    { uz: "Biz O'zbekiston bo'ylab maxsus sayohatchilik kompaniyamiz. Kichik jamoa: koordinatorlar, sinalgan gidlar va haydovchilar. Hammasi mahalliy, hammasi mintaqani ichidan biladi.",
                         ru: "Мы — небольшая туристическая компания. Компактная команда: координаторы, проверенные гиды и водители. Все местные, все знают регион изнутри.",
                         en: "We're a small travel company. A compact team: coordinators, vetted guides and drivers. All local, all know the region from the inside." },
    ...
    'why.1.title': { uz: "Rasmiy ro'yxatdan o'tgan",  ru: "Официально зарегистрированы",  en: "Officially registered" },
    'why.1.desc':  { uz: "FENIX MULTIGLOBAL O'zbekiston Respublikasida rasmiy ro'yxatdan o'tgan, STIR 309775904. Hujjatlarimiz tartibga solingan, turoperator litsenziyasi rasmiylashtirilmoqda.",
                     ru: "FENIX MULTIGLOBAL официально зарегистрирована в Республике Узбекистан, ИНН 309775904. У нас всё в порядке с документами, лицензия туроператора оформляется.",
                     en: "FENIX MULTIGLOBAL is officially registered in the Republic of Uzbekistan, INN 309775904. Our paperwork is in order; the tour-operator licence is being processed." },
    ...
    // ═══════ FOOTER ═══════
    'footer.desc':     { uz: "Toshkentdagi tour operator. O'zbekiston bo'ylab va dunyo bo'ylab sayohatlar. STIR 309775904.",
                         ru: "Туроператор в Ташкенте. Туры по Узбекистану и за рубеж. ИНН 309775904.",
                         en: "Tour operator in Tashkent. Tours within Uzbekistan and abroad. INN 309775904." },
    ...
    'footer.copy':       { uz: "© 2026 FENIX MULTIGLOBAL · barcha huquqlar himoyalangan",
                           ru: "© 2026 FENIX MULTIGLOBAL · все права защищены",
                           en: "© 2026 FENIX MULTIGLOBAL · all rights reserved" },
    ...
    'page.home.desc':        { uz: "O'zbekiston bo'ylab va dunyo bo'ylab sayohatlar. Toshkentdagi rasmiy tour operator, STIR 309775904.",
                               ru: "Туры по Узбекистану и за рубеж. Официальный туроператор из Ташкента, ИНН 309775904.",
                               en: "Tours of Uzbekistan and abroad. Official tour operator from Tashkent, INN 309775904." },
    'page.about.title':      { uz: "Biz haqimizda — FENIX MULTIGLOBAL",
                               ru: "О компании — FENIX MULTIGLOBAL",
                               en: "About us — FENIX MULTIGLOBAL" },
    'page.about.desc':       { uz: "FENIX MULTIGLOBAL — Toshkentdagi kichik tour operator. To'rt yo'nalish: ichki, kiruvchi, chiquvchi, MICE.",
                               ru: "FENIX MULTIGLOBAL — небольшой туроператор из Ташкента. Четыре направления: внутренний, въездной, выездной, MICE.",
                               en: "FENIX MULTIGLOBAL — a small tour operator from Tashkent. Four directions: domestic, inbound, outbound, MICE." },
