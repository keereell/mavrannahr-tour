...
(function () {
  ...
  const t = {
    ...
    'about.body':    { uz: "Mavrannahr Tour — Toshkentdan boshqaruv qiluvchi kichik tour operator. Mamlakatni hurmat bilan ko'rsatamiz, har bir mehmonni shaxsan bilamiz va o'z gidlarimiz va transportimiz bilan ishlaymiz.",
                       ru: "Mavrannahr Tour — небольшая туристическая компания с офисом в Ташкенте. Показываем страну с уважением, знаем каждого гостя лично и работаем со своими гидами и транспортом.",
                       en: "Mavrannahr Tour is a small tour operator based in Tashkent. We show the country with respect, know every guest personally and work with our own guides and transport." },
    ...
    'about.page.title':   { uz: "Mavrannahr Tour — Toshkentdagi <em>kichik komandа</em>",
                            ru: "Mavrannahr Tour — небольшая <em>команда из Ташкента</em>",
                            en: "Mavrannahr Tour — a small <em>team from Tashkent</em>" },
    ...
    'about.who.image.alt': { uz: "Mavrannahr Tour ofisi",
                             ru: "Офис Mavrannahr Tour",
                             en: "Mavrannahr Tour office" },
    ...
    'timeline.2.event': { uz: "Madaniy meros vazirligining litsenziyasini oldik (№ 0042-T).",
                          ru: "Получили лицензию Министерства туризма и культурного наследия (№ 0042-T).",
                          en: "Received the Ministry of Tourism and Cultural Heritage licence (№ 0042-T)." },
    ...
    'team.1.name':  { uz: "Karimov Sherzod Alisherovich", ru: "Каримов Шерзод Алишерович", en: "Sherzod Karimov" },
    ...
    'req.intro': { uz: "O'zbekiston Respublikasi Madaniy meros vazirligining talablari bo'yicha rasmiy ma'lumot.",
                   ru: "Официальная информация в соответствии с требованиями Министерства туризма и культурного наследия Республики Узбекистан.",
                   en: "Official information per Ministry of Tourism and Cultural Heritage of the Republic of Uzbekistan requirements." },
    ...
    'req.location.val':  { uz: "O'zbekiston Respublikasi<br>Toshkent sh., Yunusobod tumani<br>Amir Temur ko'chasi, 15",
                           ru: "Республика Узбекистан<br>г. Ташкент, Юнусабадский район<br>ул. Амира Темура, 15",
                           en: "Republic of Uzbekistan<br>Tashkent, Yunusabad district<br>15 Amir Temur St." },
    ...
    'req.hours.val':   { uz: "Dushanba — Juma: 09:00 — 18:00<br>Shanba: 10:00 — 15:00<br>Yakshanba: dam olish kuni",
                         ru: "Понедельник — Пятница: 09:00 — 18:00<br>Суббота: 10:00 — 15:00<br>Воскресенье: выходной",
                         en: "Monday — Friday: 09:00 — 18:00<br>Saturday: 10:00 — 15:00<br>Sunday: closed" },

    'req.director.lbl':  { uz: "Rahbar",         ru: "Руководитель",      en: "Director" },
    'req.director.head': { uz: "Karimov Sherzod<br>Alisherovich",
                           ru: "Каримов Шерзод<br>Алишерович",
                           en: "Sherzod A. Karimov" },
    'req.director.val':  { uz: "Direktor, kompaniyaning asoschisi<br><em>2012-yildan lavozimda</em>",
                           ru: "Директор, основатель компании<br><em>в должности с 2012 года</em>",
                           en: "Director, founder of the company<br><em>in office since 2012</em>" },

    'req.contact.lbl':  { uz: "Bog'lanish",      ru: "Связаться",         en: "Get in touch" },
    'req.contact.head': { uz: "Telefon va elektron pochta",
                          ru: "Телефон и email",
                          en: "Phone and email" },
    'req.contact.val':  { uz: "+998 71 200-00-00<br>info@mavrannahr.uz<br>Telegram: @mavrannahr_tour",
                          ru: "+998 71 200-00-00<br>info@mavrannahr.uz<br>Telegram: @mavrannahr_tour",
                          en: "+998 71 200-00-00<br>info@mavrannahr.uz<br>Telegram: @mavrannahr_tour" },
    ...
    'faq.4.q': { uz: "Litsenziyangiz qanday?",
                 ru: "Какая у вас лицензия?",
                 en: "What licence do you hold?" },
    'faq.4.a': { uz: "O'zbekiston Respublikasi Turizm va madaniy meros vazirligining tour operator litsenziyasi № 0042-T, 2012-yil 14-mart sanali.",
                 ru: "Лицензия туроператора Министерства туризма и культурного наследия Республики Узбекистан № 0042-T от 14 марта 2012 года.",
                 en: "Tour operator licence № 0042-T from the Ministry of Tourism and Cultural Heritage of the Republic of Uzbekistan, dated 14 March 2012." },
    ...
    'footer.copy':       { uz: "© 2012—2026 Mavrannahr Tour · barcha huquqlar himoyalangan",
                           ru: "© 2012—2026 Mavrannahr Tour · все права защищены",
                           en: "© 2012—2026 Mavrannahr Tour · all rights reserved" },
    'footer.license':    { uz: "Litsenziya № 0042-T · O'zbekiston Madaniy meros vazirligi",
                           ru: "Лицензия № 0042-T · Минтуризма Республики Узбекистан",
                           en: "Licence № 0042-T · Ministry of Tourism, Uzbekistan" },
    ...
    'privacy.p1':   { uz: "Ushbu Maxfiylik siyosati Mavrannahr Tour MChJ saytida shaxsiy ma'lumotlarni qayta ishlash tartibini belgilaydi. Sayt O'zbekiston Respublikasining 2019-yil 2-iyuldagi № O'RQ-547 \"Shaxsiy ma'lumotlar to'g'risida\" qonuni asosida ishlaydi.",
                     ru: "Настоящая Политика конфиденциальности определяет порядок обработки персональных данных на сайте Mavrannahr Tour ООО. Сайт работает в соответствии с Законом Республики Узбекистан от 02.07.2019 № ЗРУ-547 «О персональных данных».",
                     en: "This Privacy Policy defines how personal data is processed on the Mavrannahr Tour LLC website. The site operates under the Law of the Republic of Uzbekistan dated 02.07.2019 No. ZRU-547 'On Personal Data'." },
    ...
    'privacy.h6':   { uz: "6. Sizning huquqlaringiz",
                      ru: "6. Ваши права",
                      en: "6. Your rights" },
    'privacy.p6':   { uz: "Siz quyidagi huquqlarga egasiz: o'zingiz haqingizda saqlanayotgan ma'lumotlarni so'rash, ularga tuzatishlar kiritish, o'chirilishini talab qilish, qayta ishlashga roziligingizni qaytarib olish. Bu uchun bizga yozing: info@mavrannahr.uz",
                      ru: "Вы имеете право: запросить хранящиеся о вас данные, потребовать их исправления, удаления, отозвать согласие на обработку. Для этого напишите нам: info@mavrannahr.uz",
                      en: "You have the right to: request data we hold about you, ask for corrections, ask for deletion, withdraw your consent to processing. To do so write to: info@mavrannahr.uz" },

    'privacy.h7':   { uz: "7. Bog'lanish",  ru: "7. Контакты",  en: "7. Contact" },
    'privacy.p7':   { uz: "Operator: Mavrannahr Tour MChJ, Toshkent, Amir Temur ko'chasi, 15. info@mavrannahr.uz · +998 71 200-00-00",
                      ru: "Оператор: ООО «Mavrannahr Tour», г. Ташкент, ул. Амира Темура, 15. info@mavrannahr.uz · +998 71 200-00-00",
                      en: "Operator: Mavrannahr Tour LLC, Tashkent, 15 Amir Temur St. info@mavrannahr.uz · +998 71 200-00-00" },
    ...
    'nav.phone':         { uz: "+998 71 200-00-00", ru: "+998 71 200-00-00", en: "+998 71 200-00-00" },
    ...
    'page.home.title':       { uz: "Mavrannahr Tour — Toshkentdagi sayohatchilik kompaniyasi",
                               ru: "Mavrannahr Tour — туристическая компания в Ташкенте",
                               en: "Mavrannahr Tour — travel company in Tashkent" },
    ...
    'page.about.title':      { uz: "Biz haqimizda — Mavrannahr Tour",
                               ru: "О компании — Mavrannahr Tour",
                               en: "About us — Mavrannahr Tour" },
    ...
    'page.services.title':   { uz: "Xizmatlar — Mavrannahr Tour",
                               ru: "Услуги — Mavrannahr Tour",
                               en: "Services — Mavrannahr Tour" },
    ...
    'page.tours.title':      { uz: "Sayohatlar — Mavrannahr Tour",
                               ru: "Туры — Mavrannahr Tour",
                               en: "Tours — Mavrannahr Tour" },
    ...
    'page.contact.title':    { uz: "Bog'lanish — Mavrannahr Tour",
                               ru: "Контакты — Mavrannahr Tour",
                               en: "Contact — Mavrannahr Tour" },
    ...
    'page.privacy.title':    { uz: "Maxfiylik siyosati — Mavrannahr Tour",
                               ru: "Политика конфиденциальности — Mavrannahr Tour",
                               en: "Privacy policy — Mavrannahr Tour" },
    ...
    'page.offer.title':      { uz: "Ommaviy oferta — Mavrannahr Tour",
                               ru: "Публичная оферта — Mavrannahr Tour",
                               en: "Public offer — Mavrannahr Tour" },
    ...
    'page.terms.title':      { uz: "Foydalanish shartlari — Mavrannahr Tour",
                               ru: "Условия использования сайта — Mavrannahr Tour",
                               en: "Website terms of use — Mavrannahr Tour" },
