...
1. **Реальные данные компании** — найти `FENIX` и заменить на настоящее название (в `js/i18n.js` + HTML файлах + JSON-LD)
...
- **Местонахождение организации** (ул. Якка-Чинор, 2/1 — placeholder)
- **Время и дни работы** (Пн-Пт 09:00-18:00, Сб 10:00-15:00)
- **ФИО руководителя** (Исраилов Уктамжон Султанкулович — placeholder)
- **Лицензия №** (309775904 от 14.03.2012 — placeholder)
